...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='http://play.google.com/store/apps/details?id=com.guleria.gplayer')
            ],
            [
                InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url=f"http://play.google.com/store/apps/details?id=com.guleria.gplayer") ,
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='http://play.google.com/store/apps/details?id=com.guleria.gplayer'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='http://play.google.com/store/apps/details?id=com.guleria.gplayer')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='http://play.google.com/store/apps/details?id=com.guleria.gplayerT'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='http://play.google.com/store/apps/details?id=com.guleria.gplayer')
            ],[
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
