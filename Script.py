...
class script(object):
    HOME_BUTTONURL_UPDATES = environ.get("HOME_BUTTONURL_UPDATES", 'http://play.google.com/store/apps/details?id=com.guleria.gplayer')
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:http://play.google.com/store/apps/details?id=com.guleria.gplayer)</code>
